...
const PAISES = {
    ...
    ar: {
        ...
        emergencia_texto: '911',
        ley: 'Ley 25.326',
        ley_nombre: 'Ley de Protección de Datos Personales (Ley 25.326)',
        codigo_tel: '+54',
        prefijo_tel: '54',
        email_contacto: 'mylifeqrargentina@gmail.com',
        whatsapp: '+5491123456789',
        gate_titulo: 'Acceso Restringido',
        gate_subtitulo: 'Aviso de privacidad — Ley 25.326',
        gate_aceptar: 'Al aceptar confirmas que accedes con fines de atención médica de emergencia.',
        gate_boton: '✓ Entiendo — Ver perfil de emergencia',
        perfil_titulo: 'PERFIL DE EMERGENCIA',
        perfil_casco: '¡NO RETIRAR EL CASCO!',
    ...
    uy: {
        ...
        emergencia_texto: '911',
        ley: 'Ley 18.331',
        ley_nombre: 'Ley de Protección de Datos Personales (Ley 18.331)',
        codigo_tel: '+598',
        prefijo_tel: '598',
        email_contacto: 'mylifeqruruguay@gmail.com',
        whatsapp: '+59891234567',
        gate_titulo: 'Acceso Restringido',
        gate_subtitulo: 'Aviso de privacidad — Ley 18.331',
        gate_aceptar: 'Al aceptar confirmas que accedes con fines de atención médica de emergencia.',
        gate_boton: '✓ Entiendo — Ver perfil de emergencia',
        perfil_titulo: 'PERFIL DE EMERGENCIA',
        perfil_casco: '¡NO RETIRAR EL CASCO!',
    ...
    ec: {
        ...
        emergencia_texto: '911',
        ley: 'LOPDP',
        ley_nombre: 'Ley Orgánica de Protección de Datos Personales',
        codigo_tel: '+593',
        prefijo_tel: '593',
        email_contacto: 'mylifeqrecuador@gmail.com',
        whatsapp: '+593912345678',
        gate_titulo: 'Acceso Restringido',
        gate_subtitulo: 'Aviso de privacidad — LOPDP',
        gate_aceptar: 'Al aceptar confirmas que accedes con fines de atención médica de emergencia.',
        gate_boton: '✓ Entiendo — Ver perfil de emergencia',
        perfil_titulo: 'PERFIL DE EMERGENCIA',
        perfil_casco: '¡NO RETIRAR EL CASCO!',
    ...
    ve: {
        ...
        codigo_tel: '+58',
        prefijo_tel: '58',
        email_contacto: 'mylifeqrvenezuela@gmail.com',
...
function cambiarPais(codigoPais) {
    if (PAISES[codigoPais]) {
        ...
        console.warn(`⚠️ País no válido: ${codigoPais}`);
    }
}
